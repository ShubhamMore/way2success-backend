...
const birthDayWishes = async () => {
    const now = new Date();
    let milliSecTill7 = new Date(now.getFullYear(), now.getMonth(), now.getDate(), 15, 36, 0, 0) - now;
    if (milliSecTill7 < 0) {
